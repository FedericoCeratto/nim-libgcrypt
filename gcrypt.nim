...
##
## #ifndef GCRYPT_NO_DEPRECATED
## typedef struct gcry_cipher_handle *GCRY_CIPHER_HD GCRY_GCC_ATTR_DEPRECATED;
## //typedef struct gcry_cipher_handle *GcryCipherHd GCRY_GCC_ATTR_DEPRECATED;
## #endif
##
...
proc gcry_cipher_algo_name*(algorithm: cint): cstring {.
    importc: "gcry_cipher_algo_name", import_gcrypt.}
...
proc gcry_cipher_mode_from_oid*(string: cstring): cint {.
    importc: "gcry_cipher_mode_from_oid", import_gcrypt.}
...
proc gcry_pk_map_name*(name: cstring): cint {.importc: "gcry_pk_map_name", import_gcrypt.}
...
proc gcry_pk_get_param*(algo: cint; name: cstring): gcry_sexp_t {.
    importc: "gcry_pk_get_param", import_gcrypt.}
...
proc gcry_pubkey_get_sexp*(r_sexp: ptr gcry_sexp_t; mode: cint; ctx: gcry_ctx_t): gcry_error_t {.
    importc: "gcry_pubkey_get_sexp", import_gcrypt.}
## ***********************************
##                                   *
...
type
  gcry_md_hd_t {.bycopy.} = object

##  Compatibility types, do not use them.
##  #ifndef GCRYPT_NO_DEPRECATED
##  typedef struct gcry_md_handle *GCRY_MD_HD GCRY_GCC_ATTR_DEPRECATED;
##  typedef struct gcry_md_handle *GcryMDHd GCRY_GCC_ATTR_DEPRECATED;
##  #endif
...
proc gcry_md_open*(h: ptr gcry_md_hd_t; algo: cint; flags: cuint): gcry_error_t {.
    importc: "gcry_md_open", import_gcrypt.}
##  Release the message digest object HD.

proc gcry_md_close*(hd: gcry_md_hd_t) {.importc: "gcry_md_close", import_gcrypt.}
##  Add the message digest algorithm ALGO to the digest object HD.

proc gcry_md_enable*(hd: gcry_md_hd_t; algo: cint): gcry_error_t {.
    importc: "gcry_md_enable", import_gcrypt.}
##  Create a new digest object as an exact copy of the object HD.

proc gcry_md_copy*(bhd: ptr gcry_md_hd_t; ahd: gcry_md_hd_t): gcry_error_t {.
    importc: "gcry_md_copy", import_gcrypt.}
...
proc gcry_md_is_enabled*(a: gcry_md_hd_t; algo: cint): cint {.
    importc: "gcry_md_is_enabled", import_gcrypt.}
...
proc gcry_md_map_name*(name: cstring): cint {.importc: "gcry_md_map_name", import_gcrypt.}
...
proc gcry_mac_open*(handle: ptr gcry_mac_hd_t; algo: cint; flags: cuint; ctx: gcry_ctx_t): gcry_error_t {.
    importc: "gcry_mac_open", import_gcrypt.}
...
proc gcry_mpi_randomize*(w: gcry_mpi_t; nbits: cuint; level: gcry_random_level_t) {.
...
proc gcry_prime_generate*(prime: ptr gcry_mpi_t; prime_bits: cuint;
    ...
    importc: "gcry_prime_generate", import_gcrypt.}
...
proc gcry_ctx_release*(ctx: gcry_ctx_t) {.importc: "gcry_ctx_release", import_gcrypt.}
...
proc gcry_log_debugpnt*(text: cstring; point: gcry_mpi_point_t; ctx: gcry_ctx_t) {.
    importc: "gcry_log_debugpnt", import_gcrypt.}
proc gcry_log_debugsxp*(text: cstring; sexp: gcry_sexp_t) {.
    importc: "gcry_log_debugsxp", import_gcrypt.}
proc gcry_get_config*(mode: cint; what: cstring): cstring {.
    importc: "gcry_get_config", import_gcrypt.}
...
## FIXME type gcry_handler_log_t* = proc (a1: pointer; a2: cint; a3: cstring; a4: va_list)
type gcry_handler_log_t* = proc (a1: pointer; a2: cint; a3: cstring)

##  Certain operations can provide progress information.  This function
##    is used to register a handler for retrieving these information.

proc gcry_set_progress_handler*(cb: gcry_handler_progress_t; cb_data: pointer) {.
    importc: "gcry_set_progress_handler", import_gcrypt.}
...
proc gcry_is_secure*(a: pointer): cint {.importc: "gcry_is_secure", import_gcrypt.}
